      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h5>ຟອມແກ້ໄຂຂໍ້ມູນ ຂາເຂົ້າສຳນວນຄະດີອາຍາຂັ້ນລົບລ້າງ</h5>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="../index.php">Home</a></li>
              <li class="breadcrumb-item active" aria-current="page">ຟອມແກ້ໄຂຂໍ້ມູນ ຂາເຂົ້າສຳນວນຄະດີອາຍາຂັ້ນລົບລ້າງ</li>
            </ol>
          </div>
            ...
            <?php
             ...
             $stmt = "SELECT * FROM Cri_CancelIn WHERE Item_ID = ? ";   
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="Doc_No" name="Doc_No"  value="<?php echo $result["Doc_No"];?>">
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control" id="Request_Crim" name = "Request_Crim" placeholder="ໂຈດທາງອາຍາ" rows="4"  ><?php echo $result["Request_Crim"];?></textarea>
                    </div>
                  
                    <div class="form-group">
                      <label for="Request_Civil">ໂຈດທາງແພ່ງ</label>
                      <textarea class="form-control" id="Request_Civil" name = "Request_Civil" placeholder="ໂຈດທາງອາຍາ" rows="4" ><?php echo $result["Request_Civil"];?></textarea>
                    </div>
              ...
              <div class="card mb-2">     
                <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control" id="Related_Pers" name = "Related_Pers" placeholder="ຈຳເລີຍ" rows="4" ><?php echo $result["Related_Pers"];?></textarea>
                    </div>

                    <div class="form-group">
                      <label for="Respond_Civil">ບຸກຄົນທີສາມ</label>
                      <textarea class="form-control" id="Respond_Civil" name = "Respond_Civil" placeholder="ບຸກຄົນທີສາມ" rows="4" ><?php echo $result["Respond_Civil"];?></textarea>
                    </div>

                    <div class="form-group">
                      <label for="GrpName">ຊື່ໝວດການກະທຳຜິດ </label>
                      <input type="text"  class="form-control" id="GrpName" name="GrpName" value="<?php echo $result["GrpName"];?>">
                    </div>

                    <div class="form-group">
                      <label for="OtherLaw">ກົດໝາຍອື່ນ </label>
                      <input type="text"  class="form-control" id="OtherLaw" name="OtherLaw" value="<?php echo $result["OtherLaw"];?>" >
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <option value="<?php echo $result["Dept_Respond"];?>"><?php echo $result["Dept_Respond"];?></option>
