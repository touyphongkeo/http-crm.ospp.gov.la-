...
<script>
     ...
     //   alert(start);
				$.post("search_frmrequestrtqut_list_load.php",{
					start:start,
					end:end,
          Item_ID:Item_ID,
          Item_No:Item_No
      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h5>ຂາອອກຄຳຮ້ອງຂໍຮື້ຟື້ນຄະດີອາຍາ</h5>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="index.php">Home</a></li>
              <li class="breadcrumb-item">ຂາອອກຄຳຮ້ອງຂໍຮື້ຟື້ນຄະດີອາຍາ</li>
          ...
          <div class="row">
            ...
            <div class="col-lg-12">
              <div class="card mb-0" style='border: 2px solid #8640bf; border-radius: 8px;'>
                ...
                $sql = " SELECT * FROM Cri_ReQuestRetOut WHERE Item_Date = '$start'  order by item_Cnt";
