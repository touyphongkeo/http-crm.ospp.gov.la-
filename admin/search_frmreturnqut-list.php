<html>
	<body>
             ...
             <div id='show' class="table-responsive p-10">
                ...
                if($start=="" or $end==""){$btw="";}
                else{ $btw="and Cri_ReTurnOut.Item_Date between '$start' and '$end'";}


              

                if($Item_No==""){$b="";}
                else{ $b="and (Cri_ReTurnOut.Item_No like N'%$Item_No%' or Cri_ReTurnOut.Item_No like N'$Item_No%')";}

                if($Item_ID==""){$d="";}
                else{ $d="and (Cri_ReTurnOut.Item_ID like N'%$Item_ID%' or Cri_ReTurnOut.Item_ID like N'$Item_ID%')";}

               


                $i=1;
                $sql = "select *from Cri_ReTurnOut where 1=1 $btw $b $d order by Cri_ReTurnOut.item_Cnt asc";
