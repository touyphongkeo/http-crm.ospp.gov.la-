...
<script>
     ...
     //   alert(start);
				$.post("search_frmreturnqut-list-load.php",{
					start:start,
					end:end,
          Item_No:Item_No,
          Item_ID:Item_ID
      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h5>ຄຳຮ້ອງຂໍລົບລ້າງຄຳສັ່ງຕ່າງໆ ຂອງໄອຍະການອຸທອນ</h5>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="index.php">Home</a></li>
              <li class="breadcrumb-item">ຄຳຮ້ອງຂໍລົບລ້າງຄຳສັ່ງຕ່າງໆ ຂອງໄອຍະການອຸທອນ</li>
            ...
            <div class="col-lg-12">
              <div class="card mb-0" style='border: 2px solid #8640bf; border-radius: 8px;'>
                ...
                <table class='table table-bordered' style="width: 250%">
                    ...
                    $sql = " SELECT * FROM Cri_ReQuestOut WHERE Item_Date = '$start'  order by item_Cnt";
