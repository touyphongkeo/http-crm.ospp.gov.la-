...
<script>
     ...
     //   alert(start);
				$.post("search_frmreturnqut-list.php",{
					start:start,
					end:end,
          Item_No:Item_No,
          Item_ID:Item_ID
      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h5>ຄະດີອາຍາຂັ້ນຮື້ຟື້ນ</h5>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="index.php">Home</a></li>
              <li class="breadcrumb-item">ຄະດີອາຍາຂັ້ນຮື້ຟື້ນ</li>
          ...
          <div class="row">
            ...
            <div class="col-lg-12">
              <div class="card mb-0" style='border: 2px solid #8640bf; border-radius: 8px;'>
                ...
                $sql = " SELECT * FROM Cri_ReTurnOut WHERE Item_Date = '$start'  order by item_Cnt";
