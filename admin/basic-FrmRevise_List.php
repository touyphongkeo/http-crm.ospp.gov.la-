      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h2 class="h3 mb-0 text-gray-800">ຄຳສະເໜີຮື້ຟື້ນ</h2>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="index.php">Home</a></li>
              <li class="breadcrumb-item">ຄຳສະເໜີຮື້ຟື້ນ</li>
          ...
          <div class="row">
            ...
            <div class="col-lg-12">
              <div class="card mb-0" style='border: 2px solid #8640bf; border-radius: 8px;'>
               ...
               $i=0;              
               @$start=$_POST['start'];    
               $sql = "SELECT * FROM Cri_Revise WHERE Item_Date = '$start'  order by Item_Cnt";
