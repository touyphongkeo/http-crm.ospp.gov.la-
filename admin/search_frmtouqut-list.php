<html>
	<body>
             ...
             <div id='show' class="table-responsive p-10">
                ...
                if($start=="" or $end==""){$btw="";}
                else{ $btw="and Cri_TouOut.Item_Date between '$start' and '$end'";}


              

                if($Item_No==""){$b="";}
                else{ $b="and (Cri_TouOut.Item_No like N'%$Item_No%' or Cri_TouOut.Item_No like N'$Item_No%')";}

                if($Item_ID==""){$d="";}
                else{ $d="and (Cri_TouOut.Item_ID like N'%$Item_ID%' or Cri_TouOut.Item_ID like N'$Item_ID%')";}

               


                $i=1;
                $sql = "select *from Cri_TouOut where 1=1 $btw $b $d order by Cri_TouOut.item_Cnt asc";
