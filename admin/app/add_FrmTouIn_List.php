      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h5>ຕິດຕາມສໍານວນຂາເຂົ້າທວງສຳນວນຄະດີ</h5>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="../index.php">Home</a></li>
              <li class="breadcrumb-item active" aria-current="page">ຕິດຕາມສໍານວນຂາເຂົ້າທວງສຳນວນຄະດີ</li>
            </ol>
          </div>
          ...
          <?php
             ...
             from Cri_TouIn where SUBSTRING(Item_ID,4, 2)='$id_y'";   
          ...
          <?php
             include '../server/connect.php';  
             $stmts = "SELECT MAX(item_Cnt) AS item_Cnt FROM Cri_TouIn";   
