      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h5>ເພີມຂໍ້ມູນຂາເຂົ້າສຳນວນຄະດີອາຍາຂັ້ນລົບລ້າງ</h5>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="../index.php">Home</a></li>
              <li class="breadcrumb-item active" aria-current="page">ເພີມຂໍ້ມູນຂາເຂົ້າສຳນວນຄະດີອາຍາຂັ້ນລົບລ້າງ</li>
            </ol>
          </div>
          ...
          <?php
             ...
             $stmt = "select max(SUBSTRING(Item_ID,7, 5)) as m_id,max(SUBSTRING(Item_ID,1, 3)) as v 
             from Cri_CancelIn where SUBSTRING(Item_ID,4, 2)='$id_y'";   
             ...
             if($max_id<1){    $go=$v.$id_y.'.'.$id1;     }
             else if($max_id<9){  $go=$v.$id_y.'.'.'0000'.$id2;}  
             else if($max_id<99){  $go=$v.$id_y.'.'.'000'.$id2;}  
             else if($max_id<999){  $go=$v.$id_y.'.'.'00'.$id2;}  
             else if($max_id<9999){  $go=$v.$id_y.'.'.'0'.$id2;} 
             else if($max_id<99999){  $go=$v.$id_y.'.'.$id2;}
          ...
          <?php
             include '../server/connect.php';  
             $stmts = "SELECT MAX(item_Cnt) AS item_Cnt FROM Cri_CancelIn";   
             $query = sqlsrv_query( $conn, $stmts);
             $results = sqlsrv_fetch_array($query, SQLSRV_FETCH_ASSOC);

            
             $max_id=$results['item_Cnt'];
             ...
             if($max_id<1){    $no=$id1;     }
              ...
              else if($max_id<9){  $no='00'.$id2;}  // 000.2-000.9
              else if($max_id<99){  $no='0'.$id2;} // 0010-00999  //   0100 - 999 
              else if($max_id<999){  $no=$id2;}
          ...
          <div class="row">
            <div class="col-lg-6">
              ...
              <div class="card mb-4">
                ...
                <div class="card-body">
                  <form action="insert_Cancel.php"  method="POST">
                 
                  <div class="form-group">
                      <label for="item_Cnt">ເລກນັບ</label>
                      <input type="text" readonly  class="form-control" id="item_Cnt" name="item_Cnt" value="<?php echo $no;?>">
                    </div>
                  
                    <div class="form-group">
                      <label for="Item_ID">ລະຫັດຄະດີ</label>
                      <input type="text" readonly  class="form-control" id="Item_ID" name="Item_ID" aria-describedby="Item_ID" value="<?php echo $go;?>">
                    </div>
                    ...
                    <div class="form-group">
                      <label for="Doc_No">ເລກທີສໍານວນ</label>
                      <input type="text" class="form-control" id="Doc_No" name="Doc_No" required>
                    </div>

                    <div class="form-group">
                      <label for="Doc_name">ຄະດີສຳນວນ</label>
                      <select class="form-control" id="Doc_name" name = "Doc_name" >
                      <option value="ສໍານວນຄະດີອາຍາຂັ້ນລົບລ້າງ">ສໍານວນຄະດີອາຍາຂັ້ນລົບລ້າງ</option>
                      <option value="ສໍານວນຄໍາຊີ້ຂາດໂທດປະຫານຊິວິດ">ສໍານວນຄໍາຊີ້ຂາດໂທດປະຫານຊິວິດ</option>
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control" id="Request_Crim" name = "Request_Crim" placeholder="ໂຈດທາງອາຍາ" rows="4" required ></textarea>
                    </div>
                  
                    <div class="form-group">
                      <label for="Request_Civil">ໂຈດທາງແພ່ງ</label>
                      <textarea class="form-control" id="Request_Civil" name = "Request_Civil" placeholder="ໂຈດທາງອາຍາ" rows="4" required></textarea>
                    </div>

                    <div class="form-group">
                    <div id="feedback"><button type="button" class="btn btn-success btn-lg" data-toggle="modal" data-target="#feedback-modal">ເພີ່ມຂໍ້ມູນ</button></div>
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">				
                        <div class="modal-header">
                          <a class="close" data-dismiss="modal">ປິດ</a>
                          <h3>Send Feedback</h3>
                        </div>				
            ...
            <div class="col-lg-6">
              ...
              <div class="card mb-2">     
                <div class="card-body">
                    ...
                    <div class="form-group">
                      <label for="Doc_Date">ວັນເດືອນປີລົງສຳນວນ</label>
                      <input type="date"  class="form-control" id="Doc_Date" name="Doc_Date" required>
                    </div>

                    <div class="form-group">
                      <label for="Related_Pers">ຈຳເລີຍ</label>
                      <textarea class="form-control" id="Related_Pers" name = "Related_Pers" placeholder="ຈຳເລີຍ" rows="4" required></textarea>
                    </div>

                    <div class="form-group">
                      <label for="Respond_Civil">ບຸກຄົນທີສາມ</label>
                      <textarea class="form-control" id="Respond_Civil" name = "Respond_Civil" placeholder="ບຸກຄົນທີສາມ" rows="4" required></textarea>
                    </div>

                    <div class="form-group">
                      <label for="GrpName">ຊື່ໝວດການກະທຳຜິດ </label>
                      <input type="text"  class="form-control" id="GrpName" name="GrpName" required>
                    </div>

                    <div class="form-group">
                      <label for="OtherLaw">ກົດໝາຍອື່ນ </label>
                      <input type="text"  class="form-control" id="OtherLaw" name="OtherLaw" required>
                    </div>
                   

                    <div class="form-group">
                      <label for="Dept_Respond">ພະແນກຮັບຜິດຊອບ</label>
                      <select class="form-control" id="Dept_Respond" name = "Dept_Respond" >
                      <option value="ພະແນກຕິດຕາມກວດກາການດໍາເນີດຄະດີຢາເສບຕິດ">ພະແນກຕິດຕາມກວດກາການດໍາເນີດຄະດີຢາເສບຕິດ</option>
                      <option value="ພະແນກຕິດຕາມກວດກາການດໍາເນີດຄະດີອາຍາທົ່ວໄປ ແລະ ເດັກ">ພະແນກຕິດຕາມກວດກາການດໍາເນີດຄະດີອາຍາທົ່ວໄປ ແລະ ເດັກ</option>
                      <option value="ພະແນກຕິດຕາມກວດກາການດໍາເນີດຄະດີຂັ້ນຮື້ຟື້ນ ແລະ ໂທດປະຫານຊີວິດ">ພະແນກຕິດຕາມກວດກາການດໍາເນີດຄະດີຂັ້ນຮື້ຟື້ນ ແລະ ໂທດປະຫານຊີວິດ</option>
