      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h5>ເພີນຂໍ້ມູນ ຂາເຂົ້າສຳນວນຄະດີອາຍາຂັ້ນຮື້ຟື້ນ</h5>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="../index.php">Home</a></li>
              <li class="breadcrumb-item active" aria-current="page">ເພີນຂໍ້ມູນ ຂາເຂົ້າສຳນວນຄະດີອາຍາຂັ້ນຮື້ຟື້ນ</li>
            </ol>
          </div>
          ...
          <?php
             ...
             from Cri_ReturnIn where SUBSTRING(Item_ID,4, 2)='$id_y'";   
          ...
          <?php
             include '../server/connect.php';  
             $stmts = "SELECT MAX(item_Cnt) AS item_Cnt FROM Cri_ReturnIn";   
          ...
          <div class="row">
            <div class="col-lg-6">
              ...
              <div class="card mb-4">
                ...
                <div class="card-body">
                  <form action="insert_frmReturnIn.php"  method="POST">
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="Item_sam" name="Item_sam" required>
                    </div>

                    <div class="form-group">
                      <label for="Item_Date_sam">ວັນເດືອນປີລົງສຳນວນ</label>
                      <input type="date"  class="form-control" id="Item_Date_sam" name="Item_Date_sam" required>
                    </div>
