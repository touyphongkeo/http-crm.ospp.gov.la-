      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h5><B>ຂາເຂົ້າສຳນວນຄະດີອາຍາຂັ້ນລົບລ້າງ</B></h5>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="index.php">Home</a></li>
              <li class="breadcrumb-item"><B>ຂາເຂົ້າສຳນວນຄະດີອາຍາຂັ້ນລົບລ້າງ</B></li>
          ...
          <div class="row">
            ...
            <div class="col-lg-12">
              <div class="card mb-0" style='border: 2px solid #8640bf; border-radius: 8px;'>
                ...
                $sql = " SELECT * FROM Cri_CancelIn WHERE Item_Date = '$start'";
