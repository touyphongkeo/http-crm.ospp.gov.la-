<html>
	<body>
             ...
             <div id='show' class="table-responsive p-10">
                ...
                if($start=="" or $end==""){$btw="";}
                else{ $btw="and Cri_ReQuestTrueOut.Item_Date between '$start' and '$end'";}


                if($Item_ID==""){$d="";}
                else{ $d="and (Cri_ReQuestTrueOut.Item_ID like N'%$Item_ID%' or Cri_ReQuestTrueOut.Item_ID like N'$Item_ID%')";}

              

                if($In_No==""){$b="";}
                else{ $b="and (Cri_ReQuestTrueOut.In_No like N'%$In_No%' or Cri_ReQuestTrueOut.In_No like N'$In_No%')";}
                ...
                $i=1;
                $sql = "select *from Cri_ReQuestTrueOut where 1=1 $btw $b $d order by Cri_ReQuestTrueOut.item_Cnt asc";
